...
sys_path.insert(0, abspath('..'))
sys_path.insert(0, abspath('../pyAttributes'))
...
versionFile = Path(f"../{project}/__init__.py")
...
release =   __version                           # e.g. 2.3.1  The full version, including alpha/beta/rc tags.
...
htmlhelp_basename = 'pyAttributesDoc'
...
latex_documents = [
	( master_doc,
		'pyAttributes.tex',
		'The pyAttributes Documentation',
		'Patrick Lehmann',
		'manual'
	),
]
...
# ==============================================================================
autoapi_modules = {
  'pyAttributes':  {'output': "pyAttributes", "override": True}
}
